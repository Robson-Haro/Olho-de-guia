...
export const MARKET_SEGMENTS: MarketSegment[] = [
  ...
  { value: "animal_meal_oil", label: "Farinha e óleo", searchTerms: ["farinha e óleo de origem animal", "farinha de carne e ossos", "gordura animal", "graxaria", "subprodutos de origem animal", "animal rendering", "meat and bone meal", "animal fats"], seedCompanies: ["FASA Group", "Patense", "Farol Indústria de Subprodutos Animais", "Darling Ingredients"] },
